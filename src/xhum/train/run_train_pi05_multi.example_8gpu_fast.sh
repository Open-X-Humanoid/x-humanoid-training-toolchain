...
#   CONFIG=src/xhum/train/configs/your_config.json bash src/xhum/train/run_train_pi05_multi.example_8gpu_fast.sh
...
CONFIG="${CONFIG:-src/xhum/train/configs/multi_train_pi05_tianshu_72_all_white_black_upward_downward_unfreeze_vision_encoder_0607.json}"
